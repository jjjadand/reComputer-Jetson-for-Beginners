...
![NoMachine overview](./images/image-20250926160018342.png)
...
![NoMachine install result on Jetson](./images/image-20250926160530003.png)
...
![Check Jetson IP address](./images/image-20250926165250083.png)
...
![Headless NoMachine session](./images/image-20250926161036069.png)
...
![Add a new connection](./images/image-20250926164129169.png)

Enter the name and the ip address of jetson

![Enter Jetson IP](./images/image-20250926164316983.png)

Connection

![Connect to Jetson](./images/image-20250926164514138.png)

Enter your jetson username and password

![Enter Jetson credentials](./images/image-20250926164548202.png)

You have successfully connected jetson. Now you can operate your jetson on your pc.

![Jetson desktop through NoMachine](./images/image-20250926164651900.png)
